function form_OnLoad(executionContext) {
    var objKA = GetAttributeValue(executionContext, "tc_knowledgearticle");
    if (objKA != null) {
        SetAttrDisability(executionContext, "tc_knowledgearticle", true);
    }
    else {
        SetAttrDisability(executionContext, "tc_knowledgearticle", false);
    }
